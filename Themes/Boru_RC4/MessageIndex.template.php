...
function template_main()
{
	...
	{
		echo '
	<div id="board_', $context['current_board'], '_childboards" class="main_container portlet portlet--secondary portlet--rounded portlet--category m-bottom-4 boardindex_table">
		<div class="cat_bar">
			<h3 class="catbg b_indek">', $txt['sub_boards'], '</h3>
		</div>';

		foreach ($context['boards'] as $board)
		{
			echo '
			<div id="boards" class="portlet__maindar">
